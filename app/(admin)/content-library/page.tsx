...
function ContentLibraryClientContent({ 
  ...
  return (
    <PageTemplate
      ...
      loading={loading}
      error={error}
        // GridHeaderComponent and CardHeaderComponent are automatically generated by PageTemplate
...
export default function ContentLibraryPage() {
  return <ContentLibraryClient initialData={{ items: [], lastEvaluatedKey: null, total: 0 }} />
}
