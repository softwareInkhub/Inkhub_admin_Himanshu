...
import { PaginationConfig } from './types/unified-table'

interface UnifiedPaginationProps extends PaginationConfig {
  className?: string
  itemTypeName?: string
...
export default function UnifiedPagination({
  ...
  return (
    <div 
      ...
      data-scroll-group={scrollGroupId}
    >
      <div className="flex items-center space-x-4">
        <div className="text-sm text-gray-700">
          Showing {startItem} to {endItem} of {totalItems} {itemTypeName}
        </div>
