...
// Generic Product type - can be any product with at least an id
type ProductType = { id: string; [key: string]: any }

interface ProductCardViewProps<T extends ProductType = ProductType> {
  currentProducts: T[]
  selectedProducts: string[]
  onSelectProduct: (productId: string) => void
  onProductClick: (product: T, event: React.MouseEvent) => void
...
export default function ProductCardView<T extends ProductType = ProductType>({
  currentProducts,
  selectedProducts,
  onSelectProduct,
  onProductClick,
