...
interface OrderCardViewProps<T extends OrderType = OrderType> {
  data: T[]
  columns: any[]
  selectedItems: string[]
  onSelectItem: (id: string) => void
  onOrderClick?: (order: T, event: React.MouseEvent) => void
...
export default function OrderCardView<T extends OrderType = OrderType>({
  data,
  columns,
  selectedItems,
  onSelectItem,
              ...
              {visibleFields?.tags !== false && (
                <div className="flex-shrink-0">
                  ...
                  <div className="flex gap-1">
                    {order.tags.slice(0, 2).map((tag: any, index: number) => (
